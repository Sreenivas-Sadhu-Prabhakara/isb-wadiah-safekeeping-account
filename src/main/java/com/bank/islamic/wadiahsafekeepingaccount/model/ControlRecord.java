package com.bank.islamic.wadiahsafekeepingaccount.model;
...
/**
 * The BIAN control record for this service domain: "Wadiah Custody Account Fulfillment Arrangement".
 *
 ...
 * to its asset type (Wadiah Custody Account). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Wadiah Custody Account Fulfillment Arrangement";
